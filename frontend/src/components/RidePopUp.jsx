                ...
                <>
                    <div className="flex justify-between items-center mb-4 p-2">
                        <div className="flex items-center gap-3">
                            ...
                            <h4 className="text-lg font-medium text-white">{currentRide.origin}</h4>
                        </div>

                        <div>
                            <h3 className="text-xl font-medium text-green-500">{"₹" + currentRide.cost}</h3>
                        ...
                        <div className="w-full bg-[#fdfdfd] p-3 rounded-xl gap-3 my-2">
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm mt-1 text-gray-600">{currentRide.origin.charAt(0).toUpperCase() + currentRide.origin.slice(1)}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    <h3 className="text-lg font-medium">562/11-A</h3>
                                    <p className="text-sm mt-1 text-gray-600">{currentRide.destination.charAt(0).toUpperCase() + currentRide.destination.slice(1)}</p>
                                </div>
                            </div>
                        </div>
