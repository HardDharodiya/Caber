        ...
        <div className='h-screen relative overflow-hidden'>
            ...
            <div className='absolute h-screen top-0 w-full flex flex-col justify-end'>
                ...
                <div className='h-[30%] bg-gray-900 p-5 relative'>
                    ...
                    <h4 className='text-2xl font-semibold mb-5 text-white' >Find a trip</h4>
                    ...
                    <form on onSubmit={(e) => {
                        ...
                        <input
                            ...
                            className='bg-gray-100 mb-3 rounded px-10 py-2  w-full text-base placeholder:text-lg' type="text" placeholder='Pick-up location' />
                        ...
                        <input
                            ...
                            className='bg-gray-100  mb-3 rounded px-10 py-2  w-full text-base placeholder:text-lg' type="text" placeholder='Destination location' />
                    </form>
                </div>
