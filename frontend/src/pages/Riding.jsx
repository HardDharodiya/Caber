...
const Riding = () => {
    return (
        <div className="h-screen relative">
            <Link to='/home' className="fixed  h-10 w-10 bg-gray-900 flex items-center justify-center rounded-full right-4 top-4">
                ...
                <div className="bg-gray-900 p-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-white text-right">
                            <h2 className="text-lg font-medium -mt-1 -mb-1">Hard</h2>
                            <h4 className="text-xl font-semibold">GJ11 DP 6467</h4>
                    ...
                    <button className="w-full bg-[#9A6AFF] font-semibold p-3 rounded-xl my-1">Make a Payment</button>
                </div>
