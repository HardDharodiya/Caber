        ...
        <div className="h-screen bg-[#1E2029] py-4 px-4 text-white">
            <div >
                ...
                <div className="flex justify-between items-center p-4 mx-auto bg-white text-black rounded-2xl mt-5">
                    ...
                    <div className="bg-slate-300 h-16 rounded-full w-0.5">
                    </div>

                    <div>

                        <div className="flex flex-col items-end">
                            <div className="text-green-600 font-bold text-xl">₹ 500.00</div>
                            <div className="font-semibold text-sm"><span><i class="ri-wallet-3-line mr-2 "></i></span>Balance</div>
                        </div>
