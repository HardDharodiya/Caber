    ...
    <div className='bg-[#1E2029] h-screen w-full flex flex-col justify-between'>
      <div>
        ...
        <form className='ml-5 mr-5 mb-5 mt-1'
          ...
          <h3 className='text-base mb-2 text-[#ffffff] font-medium'>What's your email</h3>
          ...
          <button className='mt-1 mb-1 flex items-center justify-center w-full bg-[#9A6AFF] text-[#ffffff] py-3 rounded-xl text-xl font-semibold'>Sign up</button>

        </form>

        <p className='text-white text-center'>Already have an account ? <Link to='/login' className='text-blue-500'>Login here</Link></p>
